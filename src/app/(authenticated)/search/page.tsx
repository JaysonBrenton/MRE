...
import SearchResultsTable from "@/components/organisms/search/SearchResultsTable"
...
export default function SearchPage() {
  ...
  const { currentPage, itemsPerPage, totalPages, totalEvents, totalSessions, hasSearched } =
