    ...
    <section className="content-wrapper w-full min-w-0">
      ...
      <header className="mb-8 space-y-2">
        ...
        <p className="text-sm text-[var(--token-text-secondary)]">
          Learn how to navigate My Race Engineer effectively using breadcrumbs, menus, tabs, keyboard
          shortcuts, and other navigation patterns.
        </p>
      </header>
      ...
      <div className="space-y-6">
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <p className="mb-4 text-[var(--token-text-secondary)]">
            MRE uses several navigation patterns to help you move through the application efficiently.
            Understanding these patterns will help you find features quickly and navigate with confidence.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <p className="mb-4 text-[var(--token-text-secondary)]">
            Breadcrumb navigation is the <strong className="text-[var(--token-text-primary)]">primary navigation pattern</strong> in MRE. It shows your current location and provides a path back to previous sections. Click any breadcrumb item to navigate back to that section.
          </p>
          <p className="mb-4 text-[var(--token-text-secondary)]">
            <strong className="text-[var(--token-text-primary)]">Example:</strong> <code className="text-[var(--token-text-primary)]">Home &gt; Event Search &gt; Event Analysis</code>
          </p>
        </section>
        ...
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <div className="mt-4 rounded-md border border-[var(--token-border-muted)] bg-[var(--token-surface-elevated)] p-4">
            <h3 className="mb-2 text-sm font-semibold text-[var(--token-text-primary)]">Guides Menu in Collapsed Sidebar</h3>
        ...
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <p className="mb-4 text-[var(--token-text-secondary)]">
            Some pages use tabs to organize related content. Click or tap a tab to switch to that section. Use arrow keys to move between tabs, and Enter or Space to select. The active tab is highlighted.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <ul className="list-disc space-y-2 pl-6 text-[var(--token-text-secondary)]">
            ...
            <li><strong className="text-[var(--token-text-primary)]">Esc:</strong> Close modals or menus</li>
            <li><strong className="text-[var(--token-text-primary)]">Arrow Left/Right:</strong> Switch between tabs</li>
          </ul>
        </section>
        ...
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <p className="mb-4 text-[var(--token-text-secondary)]">
            Use the navigation menu to browse sections, check breadcrumbs to understand your location, or explore the Guides section to learn where features are located. Global search (if available) can help you find features quickly.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-[var(--token-border-default)] bg-[var(--token-surface)] p-6">
          ...
          <p className="mb-4 text-[var(--token-text-secondary)]">
            On desktop, you&apos;ll see sidebar navigation (usually always visible) with hover interactions. On mobile, navigation uses a hamburger menu (hidden by default) with touch interactions and full-screen overlays. Navigation adapts automatically to your screen size.
          </p>
        </section>
