 ...
 *
 * @relatedFiles
 * - src/components/eventAnalysis/DashboardClient.tsx (dashboard content/widgets)
 * - src/components/eventAnalysis/EventAnalysisSection.tsx (event analysis section)
...
export default async function Dashboard({ searchParams }: DashboardProps) {
  ...
  return (
    <section className="content-wrapper w-full max-w-full min-w-full shrink-0">
