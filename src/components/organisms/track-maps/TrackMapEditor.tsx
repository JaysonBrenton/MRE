...
export default function TrackMapEditor({ mapId, initialMap, onSave }: TrackMapEditorProps) {
  ...
  const handleShapeUpdate = useCallback(
    (shapeId: string, updates: Partial<TrackMapShape>) => {
      setMapData((prev) => {
        const newData = {
          ...prev,
    ...
    <div className="flex flex-col h-[calc(100vh-200px)]">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          {!trackId && (
            <div className="flex flex-col gap-1">
              <label
                htmlFor="track-map-track-select"
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-16 border-r border-[var(--token-border-default)] bg-[var(--token-surface-elevated)]">
          <ShapeToolbar selectedTool={selectedTool} onToolSelect={setSelectedTool} />
        </div>
