...
export default function ImportPrompt({
  ...
  return (
    ...
    >
      ...
      >
        <h2
          id="import-prompt-title"
          className="text-lg font-semibold text-[var(--token-text-primary)] mb-4"
        >
          Import Events?
        </h2>
