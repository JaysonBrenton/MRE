  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4">
        <label className="text-sm font-medium text-[var(--token-text-primary)]">View:</label>
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <label className="text-sm font-medium text-[var(--token-text-primary)]">Class:</label>
          ...
          <span className="text-xs text-[var(--token-text-secondary)]">(Set in Overview tab)</span>
        </div>
