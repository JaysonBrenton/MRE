/**
 * @fileoverview Chart controls component for testing tab
 *
 * @created 2025-01-24
 * @creator Auto-generated
 * @lastModified 2025-01-24
 *
 * @description Control panel for chart interactions with progressive disclosure
 *
 * @purpose Provides driver selection and metric switching controls for charts.
 *          Features quick filters (class only) by default, with "Advanced" expandable
 *          section for driver multi-select. Includes section heading.
 *
 * @relatedFiles
 * - src/components/event-analysis/ChartControls.tsx (original)
...
export default function ChartControlsTesting({
  drivers,
  races,
  selectedDriverIds,
  ...
  return (
    <section className="space-y-4 mb-6">
      ...
      <div className="space-y-3">
        <div className="relative flex-initial max-w-[300px]" ref={dropdownRef}>
        ...
        {/* Advanced Section - Expandable driver selection */}
        <div className="border border-[var(--token-border-default)] rounded-md bg-[var(--token-surface-elevated)]">
          <button
            type="button"
          ...
          {isAdvancedOpen && (
            <div className="px-4 pb-4 border-t border-[var(--token-border-default)]">
              <div className="pt-3">
                <p className="text-sm text-[var(--token-text-secondary)] mb-3">{selectionText}</p>
                <button
                  type="button"
