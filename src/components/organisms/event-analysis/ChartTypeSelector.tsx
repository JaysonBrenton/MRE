  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      <button
        ...
        className="inline-flex items-center gap-2 px-2.5 py-2 rounded-md border border-[var(--token-border-default)] bg-[var(--token-surface-elevated)] text-sm text-[var(--token-text-primary)] hover:bg-[var(--token-surface-raised)] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--token-interactive-focus-ring)] whitespace-nowrap"
      ...
      {isOpen && (
        <div className="scrollbar-none absolute left-0 z-10 mt-1 max-h-60 w-auto min-w-[200px] max-w-[280px] overflow-auto rounded-md border border-[var(--token-border-default)] bg-[var(--token-surface-elevated)] shadow-lg">
          <button
            type="button"
            onClick={() => {
            ...
            className={`w-full text-left px-3 py-2 text-sm text-[var(--token-text-primary)] hover:bg-[var(--token-surface-raised)] focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--token-interactive-focus-ring)] ${
              chartType === "best-lap"
