    ...
    <div className="border border-[var(--token-border-default)] rounded-md bg-[var(--token-surface-elevated)] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[var(--token-surface-elevated)]">
        <button
          type="button"
          onClick={onToggle}
          className="flex items-center gap-3 flex-1 text-left hover:bg-[var(--token-surface-raised)] rounded-md px-2 -mx-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--token-interactive-focus-ring)]"
        ...
        >
          ...
          <div className="text-left">
            ...
            <div className="text-xs text-[var(--token-text-secondary)]">{selectionText}</div>
          </div>
        </button>
