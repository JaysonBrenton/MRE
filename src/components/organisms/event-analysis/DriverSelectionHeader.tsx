  ...
  return (
    <div className="flex items-center gap-3" aria-live="polite">
      ...
      <button
        ...
        className="text-xs text-[var(--token-accent)] hover:text-[var(--token-accent-hover)] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--token-interactive-focus-ring)] rounded px-2 py-1"
      ...
      <button
        ...
        className="text-xs text-[var(--token-text-secondary)] hover:text-[var(--token-text-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--token-interactive-focus-ring)] rounded px-2 py-1"
