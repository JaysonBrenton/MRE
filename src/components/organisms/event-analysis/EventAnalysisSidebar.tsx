      ...
      >
        ...
        >
          ...
          <button
            ...
            className="rounded-lg p-1.5 text-[var(--token-text-secondary)] hover:bg-[var(--token-surface-raised)] hover:text-[var(--token-text-primary)] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--token-interactive-focus-ring)]"
        ...
        <div className="p-2 space-y-2">
          ...
          <div className="space-y-2">
            <SidebarAction
              ...
              label="Find Events"
              tooltip={
                selectedEventName ? `Selected: ${selectedEventName}. Find Events` : "Find Events"
              }
              shortcut="⌘E"
