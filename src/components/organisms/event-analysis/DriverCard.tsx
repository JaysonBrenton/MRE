...
export default function DriverCard({
  ...
  return (
    <div className="bg-[var(--token-surface-elevated)] rounded-md border border-[var(--token-border-default)] p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        <div>
          <div className="text-[var(--token-text-secondary)] mb-1">Best Lap</div>
          <div className="text-[var(--token-text-primary)] font-medium">
            {formatLapTime(bestLapTime)}
          </div>
        </div>
        <div>
          <div className="text-[var(--token-text-secondary)] mb-1">Avg Lap</div>
          <div className="text-[var(--token-text-primary)] font-medium">
        ...
        {consistency !== null && (
          <div>
            <div className="text-[var(--token-text-secondary)] mb-1">Consistency</div>
            <div className="text-[var(--token-text-primary)] font-medium">
