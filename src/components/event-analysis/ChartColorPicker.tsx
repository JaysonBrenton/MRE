...
export default function ChartColorPicker({
  ...
  const [adjustedPosition, setAdjustedPosition] = useState<{ top: number; left: number } | null>(position || null)
  ...
  const popoverContent = (
    ...
    >
      {label && (
        <div className="text-sm font-semibold text-[var(--token-text-primary)] mb-3">
          {label}
        </div>
      )}
