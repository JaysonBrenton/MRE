...
export default function ChartDataNotice({
  ...
  return (
    ...
    >
      ...
      <p className="font-semibold text-[var(--token-status-warning-text)] pr-8">
        {title}
      </p>
      <div className="mt-1 text-[var(--token-text-secondary)]">
        {description}
      </div>
      ...
      {remainingCount > 0 && (
        <p className="mt-1 text-[var(--token-text-muted)]">
          +{remainingCount} more
        </p>
      )}
    </div>
