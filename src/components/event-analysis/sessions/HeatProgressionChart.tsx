    ...
    >
          ...
          {({ width: parentWidth }) => {
            ...
            return (
              ...
              >
                ...
                <desc id={chartDescId}>
                  Grouped bar chart showing number of sessions per stage (qualifying, heats, finals) for each class.
                </desc>
      ...
      <div className="flex flex-wrap items-center gap-4 mt-4 text-sm">
        <div className="flex items-center gap-2">
          <div
            className="w-4 h-4"
            style={{ backgroundColor: qualifyingColor, opacity: 0.8 }}
          />
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-4 h-4"
            style={{ backgroundColor: heatColor, opacity: 0.8 }}
          />
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-4 h-4"
            style={{ backgroundColor: finalColor, opacity: 0.8 }}
          />
