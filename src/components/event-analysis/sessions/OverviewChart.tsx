    ...
    >
        ...
        <ParentSize>
          {({ width: parentWidth }) => {
            ...
            const maxParticipants = Math.max(
              ...chartData.map((d) => d.participantCount)
            )
            ...
            return (
              ...
              >
                ...
                <desc id={chartDescId}>
                  Combined chart showing race duration, participant count, and driver lap times across sessions.
                </desc>
                      ...
                      {driverLapTrends.map((trend, driverIndex) => {
                        ...
                        const lineData = chartData
                          ...
                          .filter(
                            (
                              d
                            ): d is { session: SessionData; lapTime: number } =>
                              d !== null
                          )
      ...
      <div className="flex flex-wrap items-center gap-4 mt-4 text-sm">
        <div className="flex items-center gap-2">
          <div
            className="w-4 h-4"
            style={{ backgroundColor: durationColor, opacity: 0.6 }}
          />
