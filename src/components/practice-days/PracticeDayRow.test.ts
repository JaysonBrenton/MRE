...
describe("PracticeDayRow data handling", () => {
  ...
  it("should normalize null values to 0", () => {
    const result = normalizeNumericValues(null as any, null as any, null as any, null as any)
  ...
  it("should allow toLocaleString() to be called on safeTotalLaps", () => {
    const testCases = [
      ...
      { totalLaps: null as any, expected: "0" },
    ]
  ...
  it("should handle mixed undefined and defined values", () => {
    const result = normalizeNumericValues(5, undefined, 10, null as any)
