...
export default function PracticeDayRow({
  ...
  const safeUniqueDrivers = typeof uniqueDrivers === 'number' && !isNaN(uniqueDrivers) ? uniqueDrivers : 0
  const safeUniqueClasses = typeof uniqueClasses === 'number' && !isNaN(uniqueClasses) ? uniqueClasses : 0
