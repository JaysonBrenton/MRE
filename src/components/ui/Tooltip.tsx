...
export default function Tooltip({ text, children, position = "top" }: TooltipProps) {
  ...
  const childWithProps = React.cloneElement(children, {
    ...
    // Remove title attribute if present to avoid duplicate tooltips
    title: undefined,
  })
  ...
  useEffect(() => {
    ...
    const updatePosition = () => {
      ...
      if (position === "right" || position === "left") {
        ...
        preferredLeft = position === "right"
          ? elementRect.right + gap
          : elementRect.left - tooltipWidth - gap
        ...
        preferredTop = position === "top" 
          ? elementRect.top - tooltipHeight - gap
