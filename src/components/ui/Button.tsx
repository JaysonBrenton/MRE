...
export default function Button({
  ...
  const variantClasses = {
    default: "border border-[var(--token-border-default)] bg-[var(--token-surface-elevated)] text-[var(--token-text-primary)] hover:bg-[var(--token-surface-raised)] active:opacity-90",
