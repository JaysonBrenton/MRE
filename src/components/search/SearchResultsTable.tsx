...
import { StandardTable, StandardTableHeader, StandardTableRow, StandardTableCell } from "@/components/ui/StandardTable"
...
export default function SearchResultsTable() {
  const { events, sessions, isLoading, hasSearched, error } = useAppSelector((state) => state.search)
  ...
  if (!hasSearched) {
    return (
      <div className="text-center py-8">
        <p className="text-[var(--token-text-secondary)]">Enter search criteria and click Search to see results</p>
      </div>
    )
  }
