 ...
 *
 * @relatedFiles
 * - src/components/molecules/PageContainer.tsx (page container component)
 */
...
export default function ContentWrapper({
  ...
  return (
    <section
      className={`content-wrapper mx-auto w-full min-w-0 ${maxWidthClasses[maxWidth]} ${className}`}
    >
      {children}
    </section>
  )
