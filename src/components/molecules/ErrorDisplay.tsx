 ...
 *
 * @relatedFiles
 * - src/components/organisms/event-search/EventSearchContainer.tsx (uses this component)
 */
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-[var(--token-status-error-text)]">{message}</p>
          {errorId && (
          ...
          {hasDetails && (
            <div className="mt-3">
              <button
                ...
                className="text-xs font-medium text-[var(--token-status-error-text)] hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--token-interactive-focus-ring)] rounded"
