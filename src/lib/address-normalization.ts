 ...
 *          city/state/postal/country). Does not geocode or verify against a
 *          postal authority.
 */
...
/**
 * Normalise address string for display: remove non-address data (emails, placeholders),
 * deduplicate exact segments, fix AU-style postcodes in text, and drop redundant shorter segments.
 */
