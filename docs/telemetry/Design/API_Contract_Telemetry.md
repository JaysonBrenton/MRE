...
### 4.8 Downsample levels

Downsample level names are implementation-defined but must be consistent between
API responses and pipeline output. Common conventions:
  ...
  "items": [
    {
      ...
      "name": "string",
      "track_id": "e5f6a7b8-c9d0-1234-ef01-345678901234",
...
```json
{
  "lap": {
    ...
    "splits": [
      {
        "segment_id": "c3d4e5f6-a7b8-9012-cdef-123456789012",
        "name": "Main straight",
        "duration_ms": 6123
      }
    ],
...
```json
{
  ...
  "laps": [
    {
      "lap_id": "b2c3d4e5-f6a7-8901-bcde-f12345678901",
      "lap_number": 3,
      "lap_time_ms": 41234,
      "series": {
        "s_m": [0, 1.2],
  ...
  "delta": {
    "baseline_lap_id": "b2c3d4e5-f6a7-8901-bcde-f12345678901",
    "to_baseline": [
      {
        "lap_id": "b2c3d4e5-f6a7-8901-bcde-f12345678901",
