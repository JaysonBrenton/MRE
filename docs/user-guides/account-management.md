...
- Valid email address or username
- Web browser
...
- **Email or Username** (required):
  - Enter your email address OR choose a username
...
- **Driver Name** (required):
  ...
  - This is important for event matching
  - Should match how your name appears in LiveRC events
...
1. Look for **"Log Out"** or **"Sign Out"** in the navigation menu
2. Usually in account menu or user menu
3. Click to log out
...
- Any unsaved work may be lost (save before logging out)
...
1. Look for **"Settings"** or **"Account"** in navigation
2. Usually in user menu or account menu
3. Click to access settings page
...
1. Complete your profile with accurate driver name
2. Start searching for events
3. Review discovered events
4. Begin analyzing your performance
