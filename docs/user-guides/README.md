...
**Best For:** First-time users, new account setup
...
**Best For:** Users analyzing race performance and comparing drivers
...
**Best For:** Users who want to customize their dashboard and track statistics
...
- Match types (transponder, exact, fuzzy)
- Managing driver information

**Best For:** Users who want to understand event discovery and driver matching
...
**Best For:** All users who want to navigate MRE efficiently
...
**Best For:** Users managing their account and security settings
...
**Best For:** Users experiencing issues or needing help
...
- **[Driver Features](driver-features.md)** - Event discovery and matching
- **[Navigation](navigation.md)** - Master navigation and shortcuts

### For Account Management

Manage your account:

- **[Account Management](account-management.md)** - Account setup and security
- **[Troubleshooting](troubleshooting.md)** - Resolve account issues
...
5. **Common Issues** - Quick troubleshooting
6. **Related Guides** - Links to other relevant guides
...
1. Start with the Introduction to understand what you'll learn
2. Check Prerequisites to ensure you're ready
3. Follow Step-by-Step Instructions
4. Review Tips for best practices
5. Check Common Issues if you encounter problems
6. Follow Next Steps to continue learning
...
These guides are continuously improved. If you have:

- **Suggestions**: Ideas for improving guides
- **Questions**: Things that aren't clear
- **Issues**: Problems with the guides themselves

Please contact support or provide feedback through the application.
