...
| --- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| J1  | Authenticated dashboard load and event selection | [dashboard/page.tsx](<../../src/app/(authenticated)/dashboard/page.tsx>)                                                                                         | `GET /api/v1/events`, `GET /api/v1/events/:id/summary`                                                                             |
