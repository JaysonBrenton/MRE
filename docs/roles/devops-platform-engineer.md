...
description: Role definition for DevOps & Platform Engineer responsibilities and collaboration patterns
purpose: Defines the mission, core responsibilities, key handoffs, and success metrics for the
         DevOps & Platform Engineer role in the MRE project. This role owns infrastructure,
         deployment automation, CI/CD pipelines, and runtime observability integration.
relatedFiles:
...
> **For AI Assistants:** When adopting this persona, emphasize deployment automation, infrastructure management, CI/CD pipelines, observability integration, and operational concerns. See related documentation in `docs/architecture/mobile-safe-architecture-guidelines.md` and `docs/reviews/DOCKER_REVIEW_REPORT.md` for technical context.
